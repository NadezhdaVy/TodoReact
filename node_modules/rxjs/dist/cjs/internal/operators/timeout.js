...
function timeout(config, schedulerArg) {
  var _a = isDate_1.isValidDate(config) ? { first: config } : typeof config === 'number' ? { each: config } : config,
    first = _a.first,
    each = _a.each,
    _b = _a.with,
    ...
    _c = _a.scheduler,
    scheduler =
      _c === void 0 ? (schedulerArg !== null && schedulerArg !== void 0 ? schedulerArg : async_1.asyncScheduler) : _c,
    _d = _a.meta,
