...
(function (global, factory) {
  ...
  var animationFrameProvider = {
    ...
    cancelAnimationFrame: function () {
      ...
      var delegate = animationFrameProvider.delegate;
      return (
        (delegate === null || delegate === void 0 ? void 0 : delegate.cancelAnimationFrame) || cancelAnimationFrame
      ).apply(void 0, __spreadArray([], __read(args)));
    },
    delegate: undefined,
  };
  ...
  var immediateProvider = {
    setImmediate: function () {
      ...
      return ((delegate === null || delegate === void 0 ? void 0 : delegate.setImmediate) || setImmediate).apply(
        void 0,
  ...
  function timeout(config, schedulerArg) {
    var _a = isValidDate(config) ? { first: config } : typeof config === 'number' ? { each: config } : config,
      first = _a.first,
      each = _a.each,
      _b = _a.with,
      ...
      _c = _a.scheduler,
      scheduler =
        _c === void 0 ? (schedulerArg !== null && schedulerArg !== void 0 ? schedulerArg : asyncScheduler) : _c,
      _d = _a.meta,
              ...
              createOperatorSubscriber(
                ...
                function (value) {
                  ...
                  if (
                    ...
                    subscriber.next(
                      resultSelector ? resultSelector.apply(void 0, __spreadArray([], __read(result))) : result
                    );
                    if (
    ...
    return operate(function (source, subscriber) {
      ...
      var bufferTimeSubscriber = createOperatorSubscriber(
        ...
        function (value) {
          ...
          try {
            for (
              var recordsCopy_1 = __values(recordsCopy), recordsCopy_1_1 = recordsCopy_1.next();
        ...
        createOperatorSubscriber(
          ...
          function (openValue) {
            ...
            closingSubscription.add(
              innerFrom(closingSelector(openValue)).subscribe(createOperatorSubscriber(subscriber, emitBuffer, noop))
            );
          },
          noop
        )
    ...
    return operate(function (source, subscriber) {
      ...
      var openBuffer = function () {
        ...
        innerFrom(closingSelector()).subscribe(
          (closingSubscriber = createOperatorSubscriber(subscriber, openBuffer, noop))
        );
      };
      openBuffer();
      source.subscribe(
  ...
  function catchError(selector) {
    return operate(function (source, subscriber) {
      ...
      innerSub = source.subscribe(
        createOperatorSubscriber(subscriber, undefined, undefined, function (err) {
  ...
  function dematerialize() {
    return operate(function (source, subscriber) {
      source.subscribe(
        createOperatorSubscriber(subscriber, function (notification) {
      ...
      return function (source) {
        return source.pipe(
          exhaustMap(function (a, i) {
            return innerFrom(project(a, i)).pipe(
              map(function (b, ii) {
                return resultSelector(a, b, i, ii);
              })
            );
  ...
  function groupBy(keySelector, elementOrOptions, duration, connector) {
    return operate(function (source, subscriber) {
      ...
      var groupBySourceSubscriber = new OperatorSubscriber(
        subscriber,
        function (value) {
          try {
            ...
            if (!group_1) {
              ...
              if (duration) {
                var durationSubscriber_1 = createOperatorSubscriber(
                  ...
                  function () {
                    group_1.complete();
                    durationSubscriber_1 === null || durationSubscriber_1 === void 0
                      ? void 0
          ...
          source.subscribe(
            createOperatorSubscriber(
              ...
              function () {
                ...
                try {
                  for (
                    var buffer_1 = __values(buffer), buffer_1_1 = buffer_1.next();
                    !buffer_1_1.done;
  ...
  function sequenceEqual(compareTo, comparator) {
    ...
    return operate(function (source, subscriber) {
      ...
      var createSubscriber = function (selfState, otherState) {
        var sequenceEqualSubscriber = createOperatorSubscriber(
          subscriber,
          function (a) {
          ...
          function () {
            ...
            sequenceEqualSubscriber === null || sequenceEqualSubscriber === void 0
              ? void 0
  ...
  function shareReplay(configOrBufferSize, windowTime, scheduler) {
    ...
    if (configOrBufferSize && typeof configOrBufferSize === 'object') {
      (_a = configOrBufferSize.bufferSize),
        (bufferSize = _a === void 0 ? Infinity : _a),
        (_b = configOrBufferSize.windowTime),
        (windowTime = _b === void 0 ? Infinity : _b),
        (_c = configOrBufferSize.refCount),
        (refCount = _c === void 0 ? false : _c),
      ...
      source.subscribe(
        createOperatorSubscriber(
          ...
          function (value) {
            ...
            try {
              for (
                var windows_1 = __values(windows), windows_1_1 = windows_1.next();
                !windows_1_1.done;
      ...
      innerFrom(openings).subscribe(
        createOperatorSubscriber(
          ...
          function (openValue) {
            ...
            closingSubscription.add(
              closingNotifier.subscribe(createOperatorSubscriber(subscriber, closeWindow, noop, handleError))
            );
          },
          noop
        )
      ...
      source.subscribe(
        createOperatorSubscriber(
          ...
          function (value) {
            ...
            try {
              for (
                var windowsCopy_1 = __values(windowsCopy), windowsCopy_1_1 = windowsCopy_1.next();
    ...
    return operate(function (source, subscriber) {
      ...
      var openWindow = function () {
        ...
        closingNotifier.subscribe(
          (closingSubscriber = createOperatorSubscriber(subscriber, openWindow, openWindow, handleError))
        );
      };
      openWindow();
      source.subscribe(
        ...
        try {
          for (
            ...
            _this.schedule(function () {
              ...
              try {
                for (
                  var callbacks_1 = ((e_2 = void 0), __values(callbacks)), callbacks_1_1 = callbacks_1.next();
                  !callbacks_1_1.done;
  ...
  function fromAjax(init) {
    return new Observable(function (destination) {
      var _a, _b;
      var config = __assign(
        { async: true, crossDomain: false, withCredentials: false, method: 'GET', timeout: 0, responseType: 'json' },
        init
      );
          ...
          (_b =
            (_a =
              document === null || document === void 0
                ? void 0
                : document.cookie.match(new RegExp('(^|;\\s*)(' + xsrfCookieName + ')=([^;]*)'))) === null ||
            _a === void 0
              ? void 0
      ...
      xhr = init.createXHR ? init.createXHR() : new XMLHttpRequest();
      {
        ...
        xhr.addEventListener('error', function (e) {
          var _a;
          (_a =
            progressSubscriber_1 === null || progressSubscriber_1 === void 0 ? void 0 : progressSubscriber_1.error) ===
            null || _a === void 0
            ? void 0
            : _a.call(progressSubscriber_1, e);
          emitError_1();
  ...
  function extractContentTypeAndMaybeSerializeBody(body, headers) {
    ...
    if (typeof body === 'object') {
      headers['content-type'] =
        (_a = headers['content-type']) !== null && _a !== void 0 ? _a : 'application/json;charset=utf-8';
  ...
  var WebSocketSubject = (function (_super) {
    ...
    WebSocketSubject.prototype._connectSocket = function () {
      ...
      socket.onopen = function (evt) {
        ...
        _this.destination = Subscriber.create(
          function (x) {
