...
describe('mapping-entry', () => {
  ...
  it('should return no paths for relative requested module', () => {
    const result = getPathsToTry(['.ts', 'tsx'], abosolutePathMappings, './requested-module');
  ...
  it('should get all paths that matches requested module', () => {
    const result = getPathsToTry(['.ts', '.tsx'], abosolutePathMappings, 'longest/pre/fix/requested-module');
  ...
  it('should resolve paths starting with a slash', () => {
    const result = getPathsToTry(['.ts'], abosolutePathMappingsStarstWithSlash, '/opt/utils');
    expect(result).toEqual([
      // "opt/*"
      {
