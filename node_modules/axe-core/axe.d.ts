...
declare namespace axe {
  ...
  type AriaAttrsType = 'boolean' | 'nmtoken' | 'mntokens' | 'idref' | 'idrefs' | 'string' | 'decimal' | 'int';
  ...
  type HtmlContentTypes = 'flow' | 'sectioning' | 'heading' | 'phrasing' | 'embedded' | 'interactive';
  ...
  // Context options
  type Selector = Node | BaseSelector | LabelledShadowDomSelector | LabelledFramesSelector;
  ...
  type SerialSelector = BaseSelector | LabelledShadowDomSelector | LabelledFramesSelector;
  ...
  function run<T = AxeResults>(callback: (error: Error, results: T) => void): void;
  function run<T = AxeResults>(context: ElementContext, callback: RunCallback<T>): void;
  function run<T = AxeResults>(options: RunOptions, callback: RunCallback<T>): void;
  function run<T = AxeResults>(context: ElementContext, options: RunOptions): Promise<T>;
  function run<T = AxeResults>(context: ElementContext, options: RunOptions, callback: RunCallback<T>): void;
  ...
  type Responder = (message: any | Error, keepalive?: boolean, replyHandler?: ReplyHandler) => void;
