...
interface BasePromptOptions {
  ...
  validate?: (
    value: any,
    state: any
  ) => boolean | Promise<boolean> | string | Promise<string> | Promise<string | boolean>;
...
declare type PromptOptions<T extends boolean = false> =
  | Unionize<{
...
declare type PromptTypes =
  ...
  | 'Text'
  | 'Toggle';
declare type PromptOptionsType<T> = T extends keyof PromptOptionsMap
  ? PromptOptionsMap[T]
  : T extends string
  ? BasePromptOptions & Record<PropertyKey, unknown>
  : any;
...
declare class TaskWrapper<Ctx, Renderer extends ListrRendererFactory> {
  ...
  newListr<NewCtx = Ctx>(
    task:
      | ListrTask<NewCtx, Renderer>
      | ListrTask<NewCtx, Renderer>[]
      | ((parent: Omit<this, 'skip' | 'enabled'>) => ListrTask<NewCtx, Renderer> | ListrTask<NewCtx, Renderer>[]),
...
declare class DefaultRenderer implements ListrRenderer {
  ...
  getSelfOrParentOption<T extends keyof typeof DefaultRenderer['rendererOptions']>(
  ...
  createRender(options?: { tasks?: boolean; bottomBar?: boolean; prompt?: boolean }): string;
  render(): void;
  end(): void;
 ...
 */
declare type ListrRendererValue =
 ...
 */
declare type ListrGetRendererClassFromValue<T extends ListrRendererValue> = T extends ListrDefaultRendererValue
 ...
 */
declare type ListrGetRendererValueFromClass<T extends ListrRendererFactory> = T extends DefaultRenderer
  ? ListrDefaultRendererValue
 ...
 */
declare type ListrGetRendererOptions<T extends ListrRendererValue> = T extends ListrDefaultRendererValue
 ...
 */
declare type ListrGetRendererTaskOptions<T extends ListrRendererValue> = T extends ListrDefaultRendererValue
...
declare type ListrRendererOptions<
...
declare class ListrRenderer {
  ...
  constructor(
    tasks: readonly Task<any, ListrRendererFactory>[],
 ...
 */
declare type ListrTaskResult<Ctx> =
  | string
  | Promise<any>
  | Listr<Ctx, ListrRendererValue, any>
  | Readable
 ...
 */
declare type ListrBaseClassOptions<
  Ctx = ListrContext,
 ...
 */
declare type ListrSubClassOptions<
  Ctx = ListrContext,
  Renderer extends ListrRendererValue = ListrDefaultRendererValue
> = ListrOptions<Ctx> & Omit<ListrDefaultRendererOptions<Renderer>, 'renderer'>;
...
> {
  task:
    | ListrTask<Ctx, ListrGetRendererClassFromValue<Renderer>>
    | ListrTask<Ctx, ListrGetRendererClassFromValue<Renderer>>[];
...
declare class Manager<
  Ctx = ListrContext,
  Renderer extends ListrRendererValue = 'default',
  FallbackRenderer extends ListrRendererValue = 'verbose'
> {
  options?: ListrBaseClassOptions<Ctx, Renderer, FallbackRenderer>;
  err: ListrError[];
  private tasks;
  ...
  add<InjectCtx = Ctx>(
    tasks:
      ...
      | ((ctx?: InjectCtx) => ListrTask<InjectCtx, ListrGetRendererClassFromValue<Renderer>>[]),
...
declare function createPrompt(
  this: any,
  options: PromptOptions | PromptOptions<true>[],
...
export {
  ...
  ListrTask,
  Task as ListrTaskObject,
  ListrTaskResult,
  ListrTaskState,
  TaskWrapper as ListrTaskWrapper,
  LogLevels,
  Logger,
  Manager,
  PromptError,
