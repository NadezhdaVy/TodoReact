...
function isFinalNNeeded(nextWords) {
  ...
  if (
    ...
    FIRST_TWO_DIGITS_SPOKEN_NO_N_NEEDED.indexOf(parseInt(firstWord.substring(0, 2))) == -1
  ) {
    return true;
...
var formatDistance = function formatDistance(token, count, options) {
  ...
  var usageGroup =
    options !== null && options !== void 0 && options.addSuffix ? tokenValue.withPreposition : tokenValue.standalone;
